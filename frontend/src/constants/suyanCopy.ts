...
export const SUYAN = {
  ...
  autoPrefix: "素颜",
  tagline: "卸下伪装，放肆表达自我",
  styleHint: "管理素颜的风格与话术样例",
  composeHint: "还没有素颜",
  myListHint: "请先在「我的素颜」里添加至少一个。",
  switchHint: "请切换素颜或补充资料条目后再试。",
  ...
  polishFor: "让素颜润色这段话",
  openSuggest: "打开素颜推荐",
  emptyAutoCreateHint: "点击下方「新建素颜」将自动创建 素颜-1、素颜-2…，点击进入后可修改名称并添加内容。",
  mineHint: "来源：自己创建，或从素颜世界加入。新建与详情在「素颜信息管理」中维护。",
  mineEmpty: "这里还没有素颜",
  mineEmptyDetail: "可新建，或前往素颜世界浏览并加入。创建后在详情页维护信息条目。",
} as const;
